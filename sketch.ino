...
// Wi-Fi credentials
const char* ssid = "G-Zone";          // Replace with your Wi-Fi SSID
const char* password = "+2962024";  // Replace with your Wi-Fi password

// CallMeBot credentials for WhatsApp
const char* phoneNumber = "201156921214";   // Replace with your phone number (omit + sign)
const char* apiKey = "6189167";             // Replace with your CallMeBot API key
const char* message = "  Motion Detection Alert ";   // WhatsApp message text

// PIR Sensor and Buzzer pins
#define PIR_PIN D0    // GPIO pin for PIR sensor
#define BUZZER_PIN D1 // GPIO pin for buzzer
...
void loop() {
  ...
  if (motionDetected) {
    ...
    delay(5000); // Delay to prevent spamming messages
  } else {
